...
本文是一个简单教程, 通过 `Next.js` 制作 静态网站, 然后通过 `GitHub Actions`构建打包 将其自动化部署到  `GitHub Pages`用于展示
...
* [Github Pages](https://docs.github.com/en/pages) 是 静态站点托管服务
...
2. 将 `remote`名称 设置为上传 GitHub的 `remote`名称
